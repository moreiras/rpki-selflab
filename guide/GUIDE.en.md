...
AS666 has read the same documentation you have. ROV only looks at the **last**
...
1. Switch AS666 to the forged-path attack:
   ...
   **That relationship is a lie.** AS666 has no BGP session with AS64500, no
...
4. Now the observers:
   ...
   **Provider A's own path is already gone.** It stopped advertising it the
   ...
   Provider A instead is the leaked path, `64501 64499 64500`, and since
