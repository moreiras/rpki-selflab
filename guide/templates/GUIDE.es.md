...
- **El AS{{ATTACKER_ASN}} y el peer.** Seis comandos (`step1-clean`, `step2-hijack-simple`,
...
3. Mire de nuevo: el secuestro desapareció de la tabla. No se perdió -
   ...
   La insignia ahora dice *ROV: descartando*. El secuestro fue derrotado. El AS{{ATTACKER_ASN}} sigue
...
> **Estado:** etapa `rov-drop` · AS{{ATTACKER_ASN}} haciendo el secuestro ingenuo (descartado) · peer
...
3. Mire:
   ...
   *     V-? {{ORIGIN_V4}}          10.200.5.10       100     0 {{PROVIDER_A_ASN}} {{ORIGIN_ASN}} {{ORIGIN_ASN}} {{ORIGIN_ASN}} i
   ...
   - el camino termina en {{ORIGIN_ASN}}, que es exactamente lo que autoriza la ROA. Los
...
> **Estado:** etapa `rov-drop` · AS{{ATTACKER_ASN}} falsificando el camino · peer en silencio · ROAs para
...
falsificado del AS{{ATTACKER_ASN}}. ¿Cuál es la otra, y es eso lo que quería? ¿Qué
...
> **Estado:** etapa `aspa-drop` · AS{{ATTACKER_ASN}} falsificando el camino · peer en silencio · ROAs para
...
2. Verifique los observadores:
   ...
   *     V-V {{ORIGIN_V4}}          10.200.5.10       200     0 {{PROVIDER_A_ASN}} {{ORIGIN_ASN}} {{ORIGIN_ASN}} {{ORIGIN_ASN}} i
   ...
   el AS{{ATTACKER_ASN}} - que sigue anunciando - sigue derrotado. Note que el arreglo no
   involucró al AS{{ATTACKER_ASN}} en absoluto: el objeto ASPA describe *sus* relaciones, y
...
> **Estado:** etapa `aspa-drop` · AS{{ATTACKER_ASN}} falsificando el camino (derrotado) · peer en silencio
...
> `krillc aspas add --aspa "AS{{ORIGIN_ASN}} => AS{{PROVIDER_A_ASN}}, AS{{PROVIDER_B_ASN}}"` (esto reemplaza el
> objeto por exactamente esa lista), luego `./scripts/lab.sh refresh`.
...
1. Para ver los veredictos, vuelva a poner la verificación ASPA en su etapa de marcado - una
   ...
   *     V-! {{ORIGIN_V4}}          10.200.5.10        20     0 {{PROVIDER_A_ASN}} {{PEER_ASN}} {{ORIGIN_ASN}} i
   ...
   Proveedor A: `{{PROVIDER_A_ASN}} {{PEER_ASN}} {{ORIGIN_ASN}}`. Dos cosas para notar:
...
`bgp_path: {{PROVIDER_B_ASN}} {{ORIGIN_ASN}}` - un
camino perfectamente legítimo por un proveedor autorizado - pero **ROV
Invalid**: la ROA de `{{ORIGIN_V4}}` solo autoriza anuncios hasta
