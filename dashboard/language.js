...
// rir-web/panel.html - kept as two copies (one per container/build context)
// rather than one shared HTTP origin, since the file is tiny and the two
// panels are served by different containers.
//
